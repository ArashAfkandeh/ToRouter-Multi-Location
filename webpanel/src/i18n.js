export const translations = {
    en: {
        ...
        nav_subtitle: "Multiple locations with one Server",
        btn_support: "Support",
        btn_star: "Star",
        ...
        modal_set_web_base_path: "Web Base Path",
        ...
        modal_set_ssl_warning: "For Auto-SSL, port 443 must be available.",
    ...
    fa: {
        ...
        nav_subtitle: "چندین لوکیشن با یک سرور",
        ...
        modal_set_web_base_path: "مسیر پایه وب",
        ...
        modal_set_ssl_warning: "برای دریافت خودکار گواهی SSL، باید پورت ۴۴۳ در دسترس باشد.",
