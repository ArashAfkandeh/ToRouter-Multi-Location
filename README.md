...
## ⌨️ منوی تعاملی CLI
این برنامه دارای یک منوی CLI کاملاً تعاملی است که با دستور `tor-p` در خط فرمان سرور شما در دسترس قرار می‌گیرد. ویژگی‌های منوی:
...
**توروتر** امکان تعریف و حفظ چند مسیر تور با خروجی از کشورها و سرورهای متفاوت را فراهم می‌کند؛ هر مسیر می‌تواند برای یک کشور مشخص تنظیم شود.

<p align="center">
  <img src="./preview/tor-nodes.png" alt="گره‌های تور بر اساس کشور">
</p>

[**گره‌های تور بر اساس کشور**](https://tor-nodes-by-country.arashaf1371.workers.dev)
