...
- مناسب برای کاربرانی که می‌خواهند چند کانال تور را هم‌زمان داشته باشند
...
- تمرکز روی سرورهای چند مکانی با پشتیبانی خروجی از کشورها و روت‌های متفاوت
...
Tor Router امکان تعریف و حفظ چند مسیر تور با خروجی از کشورها و سرورهای متفاوت را فراهم می‌کند. هر مسیر می‌تواند به صورت مستقل سوئیچ شود و وضعیت IP خروجی در بازه‌های زمانی مشخص ثبت شود.
...
Tor Router مناسب است برای کنترل حرفه‌ای مسیرهای تور و حفظ حریم خصوصی با دیدی واضح و رابط کاربری ساده.
